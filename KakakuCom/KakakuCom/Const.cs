...
//		public static string z_envmf = z_strDb1;				// 環境設定　"mf1" OR "mf2"
		public static string[] z_strHPUrl = { "https://omoto.me", "http://omoto.me" };	// おもとめ　ホームページURL
		...
		public static string z_pathKakakuData = "\\xampp\\htdocs\\Af0\\tmp\\";

		// 補正値
		public static double z_fMinKakakuHosei = 1.00;			// 最安値補正値

		// MAX値
		public static int z_nCategoryMax = 50;					// 全カテゴリ最大数	(17/8/19 30)
		public static int z_nLClassMax = 100;                   // 全大分類最大数	(17/8/19 68)
		public static int z_nMClassMax = 200;                   // 全中分類最大数	(17/8/19 107)
		public static int z_nSClassMax = 2500;                  // 全小分類最大数	(17/8/19 1592)
		public static int z_nMSCRelationMax = 3000;             // 全中小分類最大数	(17/8/19 1702)
		public static int z_nAttrNameMax = 5000;                // 全属性名最大数	(17/8/19 2888)
		public static int z_nAttrValueMax = 4000000;            // 全属性値最大数	(17/8/19 2246351)
		public static int z_nAttrURLMax = 1000000;				// 全URL最大数		(17/8/19 560468)
		public static int z_nSyohinMax = 200000;                // 全商品最大数		(17/8/19 100772)

		public static int z_nSClassSyohinMax = 20000;			// 小分類毎の商品最大数
		public static int z_nSClassAttrNameMax = 200;			// 小分類毎の[属性名]と[属性ID]の最大数 と 一般属性IDの最大番号(<1000)
		public static int z_nSClassZukeiMax = 60000;			// 小分類毎の図形最大数
		...
		public static int z_nSyohinZukeiMax = 60;				// 商品毎の図形最大数
		public static int z_nProductInfoMax = 4;                // 商品毎のメーカー製品情報最大数
		public static int z_nCtrlIDMax = 1000;                  // 制御レコード最大数
		public static int z_nPageSyohinMax = 50;                // 商品一覧HPの1ページ毎の最大商品数
        ...
        public static uint z_iSClassID2Unit = 100000;            // 商品IDに付加する小分類IDの乗数
                                                                // ID先頭
...
//		public static string z_strSClass1Table = "sclass";
		public static string z_strSClass2Table = "sclass2";
		public static string z_strMSCRelation = "mscrelation";
		public static string z_strAttributeNameTable = "attrname";
//		public static string z_strAttributeValue1Table = "attrvalue";
		public static string z_strAttributeValue2Table = "attrvalue2";
//		public static string z_strAttributeURL1Table = "attrurl";
		public static string z_strAttributeURL2Table = "attrurl2";
//		public static string z_strSyohin1Table = "syohin";
		public static string z_strSyohin2Table = "syohin2";
		...
		public static string z_urlKakakuDataHomePage = "https://kakaku.com/";			// ホームページURL

		public static string z_urlKakakuHome = "https://kakaku.com";						// 次ページURL作成用
		...
		public static string z_urlKakakuAllSyohin = "itemlist.aspx?pdf_pg=1";          // 全商品

		public static string z_pathBackupDBShell = "\\xampp\\htdocs\\cf0\\Bin\\";		// DB Backup シェル　フォルダ
		...
		public static string[] z_envdir = { "\\xampp\\htdocs\\mf1", "\\xampp\\htdocs\\mf2" };				// 環境 ディレクトリ　
		public static string[] z_pathSyohinBaseHP = { z_envdir[0] + "\\prg\\", z_envdir[1] + "\\prg\\" };   // 基準商品Hフォルダ
		public static string[] z_pathTransDB = { z_envdir[0] + "\\DB\\", z_envdir[1] + "\\DB\\" };			// 転送用DBフォルダ

		// 図形と商品HPはmf1以下にまとめる
		public static string[] z_pathZukeiData = { z_envdir[0] + "\\z", z_envdir[1] + "\\z" };              // 図形データフォルダ
		public static string z_pathZukeiIns = "\\new\\";                                                    // 新規追加図形フォルダ
		public static string z_pathZukeiNoRed = "\\nored\\";                                                // 新規追加図形フォルダ

		public static string[] z_pathCategoryBaseHP = { z_envdir[0] + "\\prg\\", z_envdir[1] + "\\prg\\" };	// 基準カテゴリHPフォルダ

		public static string z_pathBackupDBFolder = "\\DB\\Backup\\";										// DB Backup フォルダ
		...
		public static string[] z_strSitemapFolder = { "\\sitemap.xml", "\\sitemap01.xml" };											// サイトマップXMLファイル
		public static string z_strDBBackupFilter = " DB Backup File(*.sql)|*.sql";
		public static string z_pathMatukenDB = "\\DB\\Matsuken\\";										// Text DB / Dump フォルダ
